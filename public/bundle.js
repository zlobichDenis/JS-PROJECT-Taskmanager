...
class AbstractSmartComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__.default {
    ...
    rerender() {
        ...
        const parent = oldElemenet.parentElement;
...
const createColorsMarkup = () => {
  return _const_js__WEBPACK_IMPORTED_MODULE_1__.COLORS_CARD.map((color) => {
    return `
...
const createEditCardForm = (task) => {
  ...
  const isExpired = dueDate instanceof Date && dueDate < Date.now(); 
  const isDateShowing = !!dueDate;
  const date = isDateShowing ? `${dueDate.getDate()} ${_const_js__WEBPACK_IMPORTED_MODULE_1__.MONTH_NAMES[dueDate.getMonth()]}` : '';  
...
class EditForm extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_4__.default {
  constructor(task) {
    super()
    this._task = task;
    ...
    render(task) {
        ...
        const clickOnEditBtn = () => {
          ...
          if(oldTaskEditComponent && oldTaskComponent) {
              (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._taskComponent, oldTaskComponent);
              (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._taskEditComponent, oldTaskEditComponent);
          } else {
              (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this._container, this._taskComponent, _render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.BEFOREEND);
          }
    }
